...
function App() {
  ...
  const attractionDetails: { [key: string]: { title: string; content: string } } = {
    furongding: {
      title: "芙蓉顶详细介绍",
      content: "芙蓉顶位于连山壮族瑶族自治县境内，海拔1659米，是连山县的最高峰，也是粤北地区的重要山峰之一。这里山势雄伟壮观，常年云雾缭绕，宛如仙境。芙蓉顶因其山形似盛开的芙蓉花而得名，山顶视野开阔，可俯瞰整个连山县城和周边群山。每当日出日落时分，金光洒向大地，云海翻腾，景色格外壮美。山上植被茂密，有珍贵的原始森林，空气清新，负氧离子含量极高，是天然的大氧吧。登山路径虽然有一定难度，但沿途风景秀丽，有多处观景台供游客休息观赏。春季山花烂漫，夏季绿意盎然，秋季层林尽染，冬季雾凇晶莹，四季各有特色。这里也是摄影爱好者的天堂，无论是日出云海、星空银河，还是山花野草，都能拍出令人惊艳的作品。"
    },
    jinzishan: {
      title: "金子山详细介绍", 
      content: "金子山位于连山县境内，以其独特的喀斯特地貌和奇峰异石而闻名。山中分布着众多天然溶洞，洞内钟乳石形态各异，有的像金子闪闪发光，因此得名金子山。这里的石峰造型奇特，有的像雄鹰展翅，有的像仙女下凡，充满了神话色彩。山中植被丰富，有多种珍稀植物和野生动物，生态环境保护良好。金子山的溶洞群是其最大特色，洞内温度常年保持在18-20度，冬暖夏凉，是避暑的好去处。洞中有地下河流，水质清澈甘甜，形成了独特的地下水景观。山上还有多处观景台，可以欣赏到壮美的山景和田园风光。当地壮族瑶族同胞世代在此生活，留下了许多美丽的传说故事。金子山四季景色各异，春天山花烂漫，夏天绿树成荫，秋天红叶满山，冬天雾凇晶莹，是摄影和写生的绝佳场所。"
    },
    dawushan: {
      title: "大雾山详细介绍",
    ...
    wushan: {
      title: "雾山梯田详细介绍",
      content: "雾山梯田是连山县最具代表性的农业景观之一，位于海拔600-1000米的山坡上，总面积达数千亩。这些梯田是当地壮族瑶族先民经过数百年辛勤劳作开垦而成，体现了山区人民的智慧和毅力。梯田依山而建，层层叠叠，从山脚一直延伸到山顶，远远望去如同天梯一般壮观。春季时节，梯田注水准备插秧，在阳光照射下波光粼粼，如同镜面一般美丽。夏季稻苗青翠，绿浪翻滚，生机盎然。秋季稻谷成熟，金黄一片，丰收的喜悦洋溢在每一层梯田上。冬季虽然稻田休耕，但梯田的轮廓依然清晰可见，别有一番韵味。雾山梯田不仅是美丽的景观，更是重要的农业文化遗产，这里种植的是优质的山区大米，口感香甜，营养丰富。当地农民至今仍保持着传统的耕作方式，使用水牛犁田，手工插秧，体现了人与自然和谐共生的理念。"
    },
    oujia: {
      title: "欧家梯田详细介绍",
    ...
    zhengqi: {
      title: "政岐村蒙峒景区详细介绍",
      content: "政岐村蒙峒景区位于连山县禾洞镇，是一个保存完好的壮族瑶族传统村落，被誉为'活着的民族文化博物馆'。这里居住着纯朴的壮族瑶族同胞，至今仍保持着传统的生活方式和民族习俗。村中的建筑多为传统的干栏式木楼，依山而建，错落有致，与周围的自然环境完美融合。这些木楼采用传统工艺建造，不用一颗钉子，全靠榫卯结构连接，体现了古代建筑的智慧。村民们穿着传统的民族服装，说着本民族语言，保持着古老的生活习惯。在这里，游客可以观看到正宗的壮族瑶族歌舞表演，品尝到地道的民族美食，购买到精美的手工艺品。村中还有传统的织锦、刺绣、竹编等手工艺作坊，游客可以亲自体验制作过程。政岐村的自然环境也十分优美，四周青山环抱，溪水潺潺，空气清新。这里是体验壮瑶民族文化、感受原生态乡村生活的最佳场所，让游客在现代化快节奏生活中找到一片宁静的净土。"
    }
  };
                    ...
                    {[
                      {
                        ...
                        description: "连山最高峰，海拔1659米，山势雄伟，云海缭绕，是观日出日落的绝佳位置。",
                        tags: ["高山美景", "日出云海", "登山徒步"]
                      },
                      {
                        id: "jinzishan",
                        ...
                        description: "以奇峰异石著称，山中有天然溶洞，四季景色各异，是摄影爱好者的天堂。",
                        tags: ["奇峰异石", "天然溶洞", "摄影胜地"]
                      },
                      {
                        id: "dawushan",
                      ...
                      },
                      {
                        id: "wushan",
                        name: "雾山梯田",
                        image: ATTRACTION_IMAGES.wushan,
                      ...
                      },
                      {
                        ...
                        description: "壮族瑶族聚居村落，保留原生态民族风情，体验传统民族文化的最佳去处。",
                        tags: ["民族村落", "传统文化", "原生态"]
                      }
